...
const RightSide = () => {
  ...
  return (
    data && 
    <>
      <div className='bg-white lg:w-[320px] border-l-[1.1px] border-gray-200 flex flex-col gap-5 md:py-0 rounded-xl'>
       
       <div className='w-full mx-auto py-[.9569rem] flex justify-between px-8 border-b-[1.1px] border-gray-200'>
