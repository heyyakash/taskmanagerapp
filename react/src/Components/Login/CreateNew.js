        ...
        <div className=' w-[100%] h-[100vh] fixed bg-primary flex justify-center items-center'>
            ...
            <div className='bg-white drop-shadow-2xl rounded-md p-[2rem] justify-center w-[300px]'>
                    ...
                    <div className="grid xl:grid-cols-2 xl:gap-6">
                        <div className="relative z-0 w-full mb-6 group">
                            <input type="text" name="floating_first_name" id="floating_first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                                <label htmlFor="floating_first_name"  value={fname} onChange={(e) => setFname(e.target.value)} className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First name</label>
                        </div>
                        <div className="relative z-0 w-full mb-6 group">
                ...
                {/* <form className='flex flex-col justify-center items-start gap-3 '>
                    ...
                    First Name: <input type="text" placeholder='Enter your first name'  className="bg-secondary w-full h-[30px] outline-primary px-2" />
                    Last Name: <input type="text" placeholder='Enter your last name'  className="bg-secondary w-full h-[30px] outline-primary px-2" />
                    Username: <input type="text" placeholder='Enter username'  className="bg-secondary w-full h-[30px] outline-primary px-2" />
                    Password: <input type="password" placeholder='Not less than 5 characters'  className="bg-secondary w-full h-[30px] outline-primary px-2" />
